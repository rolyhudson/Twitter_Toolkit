...
namespace BH.Engine.Twitter
{
    public static partial class Convert
    {
        ...
        public static string ToRequestBody(this PremiumSearchParameters searchParameters)
        {
            ...
            if (searchParameters.ToDate != "") body += "\"toDate\":\"" + searchParameters.ToDate + "\",";
            if (searchParameters.Tag != "") body += "\"tag\":\"" + searchParameters.Tag + "\",";
            if (searchParameters.Next != "") body += "\"next\":\"" + searchParameters.Next + "\",";
